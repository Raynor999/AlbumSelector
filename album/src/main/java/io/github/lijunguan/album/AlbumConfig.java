package io.github.lijunguan.album;
...
public class AlbumConfig implements Parcelable {
    ...
    public int getSlecteModel() {
        return mSlecteModel;
    }

    public void setSlecteModel(int mSlecteModel) {
        this.mSlecteModel = mSlecteModel;
    }
    ...
    public AlbumConfig() {
        ...
        mShownCamera = true;
        mSlecteModel = ImgSelector.MULTI_MODEL;
        mGridColumns = 3;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeInt(this.mSlecteModel);
